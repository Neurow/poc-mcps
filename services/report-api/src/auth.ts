...
// Même principe que Ticket API / Planning API : cache en mémoire des
// Report Service Tokens, TTL court pour rendre expiration/renouvellement
// observables. Système indépendant -> implémentation dupliquée.
